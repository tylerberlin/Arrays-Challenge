...
struct ContentView: View {
     ...
     ************************************/
    @State private var myFavoriteMovies : [String]? = ["Toy Story", "Top Gun", "Spider Man", "Star Wars", "Avengers"]
                ...
                if s1Check == 0 {
                    Button("Test Stretch 1") {
                        ...
                        if var myFavoriteMovies = myFavoriteMovies {
                            ...
                            myFavoriteMovies[1] = "Forrest Gump"
                            myFavoriteMovies.append("Ready Player One")
                            myFavoriteMovies.insert("Inside Out", at: 2)
